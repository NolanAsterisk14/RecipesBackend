...
namespace MinimalRecipesAPI.Data
{
    public class MinimalRecipesAPIContext : DbContext
    {
        public MinimalRecipesAPIContext(DbContextOptions<MinimalRecipesAPIContext> options) : base(options) { }
